...
export const PAPER_OPTIONS: PaperOption[] = [
  ...
  { name: "65 Cover (White)", isCardstock: true, thickness: 0.00225, availableSizes: ["8.5x11", "11x17"] },
  { name: "67 Cover (White)", isCardstock: true, thickness: 0.00225, availableSizes: ["8.5x11", "11x17"] },
  { name: "67 Cover (Off-White)", isCardstock: true, thickness: 0.00225, availableSizes: ["8.5x11", "11x17"] },
