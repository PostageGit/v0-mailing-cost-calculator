...
const NODES: Node[] = [
  ...
  { id: "booklet-engine",  label: "Booklet Pricing",   group: "engine", description: "Cover + inside pricing with separate paper stocks, quantity break tiers, binding charges, scoring add-on. Supports cardstock detection.",                                                                   files: ["lib/booklet-pricing.ts", "lib/booklet-types.ts"] },
